...
from Mahasiswa import Mahasiswa # Class mahasiswa dari mahasiswa.py
...
class WindowMahasiswa(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def select_data(self):
        try:
            ...
            self.gridMahasiswa.setHorizontalHeaderLabels(['ID', 'Nim', 'Nama', 'Fakultas', 'Prodi'])
    ...
    def search_data(self):
        try:           
            ...
            a = mhs.affected
            if(a!=0):
                self.txtNIM.setText(mhs.nim.strip())
                self.txtNama.setText(mhs.nama.strip())
                self.cboFakultas.setCurrentText(mhs.fakultas.strip())
